...
void set_salt(char* val){
  ...
  ESP_LOGI(TAG, "4nd byte is: %d", val[4]);
  ESP_LOGI(TAG, "5nd byte is: %d", val[5]);
  ESP_LOGI(TAG, "6nd byte is: %d", val[6]);
  ESP_LOGI(TAG, "7nd byte is: %d", val[7]);
